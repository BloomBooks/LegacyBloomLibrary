    ...
    copy: {
      ...
      css_less: {
        files: [
          ...
          {
            src: ["vendor/angular-ui-grid/ui-grid.min.css"],
            dest: "vendor/angular-ui-grid/ui-grid.min.less"
          },
          {
            src: ["vendor/ng-tags-input/ng-tags-input.min.css"],
            dest: "vendor/ng-tags-input/ng-tags-input.min.less"
          }
        ]
      }
    },
